...
namespace BudgetTool.Controllers
{
    public class ContentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,MediaURL")] Content content)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,MediaURL")] Content content)
        {
            if (id != content.Id)
            {
                return NotFound();
